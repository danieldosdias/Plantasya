...
public class PlayerMovement : MonoBehaviour
{
    ...
    {
        questionBoxManager = QuestionBoxManager.GetInstance();
        questionTrigger = QuestionTrigger.GetInstance();
    }
    ...
    {
        if (collision.tag == "Question" && questionBoxManager.waitingForAnswer == false)
        {
        ...
        {
            //End of Game Panel Appears
            endGamePanel.SetActive(true);
            Debug.Log("acaba o jogo");
            endGameScore.text = gameScore.text;
        }
    }
